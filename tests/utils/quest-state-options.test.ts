...
describe('Quest State Options', () => {
  describe('ComponentTemplates', () => {
    test('should have math templates', () => {
      ...
      expect(ComponentTemplates.math.map(c => c.name)).toEqual(['add', 'subtract', 'multiply', 'divide']);
    });
    ...
    test('should have utils templates', () => {
      ...
      expect(ComponentTemplates.utils.map(c => c.name)).toEqual(['validators', 'formatters', 'helpers']);
    });
  ...
  describe('AgentReportTemplates', () => {
    ...
    describe('codeweaver', () => {
      test('should generate codeweaver report', () => {
        const report = AgentReportTemplates.codeweaver('Create config.ts with configuration', 'Complete');
      ...
      test('should extract component name correctly', () => {
        const report = AgentReportTemplates.codeweaver('Create userService.ts with user management', 'Complete');
    ...
    describe('spiritmender', () => {
      ...
      test('should generate spiritmender report for ongoing issues', () => {
        const blockers = [
          { type: 'ward_failure', description: 'ESLint errors' }
        ];
  ...
  describe('FileGenerators', () => {
    describe('implementation', () => {
      ...
      test('should generate subtract function', () => {
        const code = FileGenerators.implementation('subtract', 'function that subtracts two numbers');
