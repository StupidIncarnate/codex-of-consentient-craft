...
this spec is approved and the user starts the quest, the PestEater agent writes a failing test first, fixes it, then
ward → blightwarden → ward verify the fix.
