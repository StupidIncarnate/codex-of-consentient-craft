...
18. **Address gaps** - Review findings, update quest. Use the `mcp__dungeonmaster__ask-user-question` MCP tool for any
    unknowns. When you need to ask the user questions, use the ask-user-question MCP tool. The user's answers will
    arrive as your next message when the session resumes.
