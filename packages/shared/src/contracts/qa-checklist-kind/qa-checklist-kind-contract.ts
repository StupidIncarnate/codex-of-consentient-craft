 ...
 * an `off-map` unit is a probe family the graph never draws. Every unit is independently
 * dispositioned in `quest.planningNotes.qaLedger`, so coverage is counted rather than remembered.
 */
