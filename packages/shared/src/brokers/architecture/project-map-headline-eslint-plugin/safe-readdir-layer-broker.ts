 ...
 *
 * USAGE:
 * const entries = safeReaddirLayerBroker({ dirPath: absoluteFilePathContract.parse('/project/src/brokers/rule') });
 * // Returns Dirent[] or empty array if directory does not exist
 *
 * WHEN-TO-USE: When scanning rule directories where non-existent directories should be skipped
 */
