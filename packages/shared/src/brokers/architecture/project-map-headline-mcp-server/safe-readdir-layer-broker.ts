 ...
 *
 * USAGE:
 * const entries = safeReaddirLayerBroker({ dirPath: absoluteFilePathContract.parse('/project/src/flows') });
 * // Returns Dirent[] or empty array if directory does not exist
 *
 * WHEN-TO-USE: When scanning flow directories where non-existent directories should be skipped
 */
