import { projectMapHeadlineProgrammaticServiceStatics } from './project-map-headline-programmatic-service-statics';

describe('projectMapHeadlineProgrammaticServiceStatics', () => {
  it('VALID: statics => match expected shape', () => {
    expect(projectMapHeadlineProgrammaticServiceStatics).toStrictEqual({
