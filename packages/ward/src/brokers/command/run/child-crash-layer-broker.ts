/**
 * PURPOSE: Layer of multiPackageLayerBroker — turns a child ward process that produced no
 ...
 *
 * USAGE:
 * const checks = childCrashLayerBroker({ projectFolder, checkTypes: ['lint'], exitCode, output });
...
export const childCrashLayerBroker = ({
  projectFolder,
  checkTypes,
  exitCode,
  output,
