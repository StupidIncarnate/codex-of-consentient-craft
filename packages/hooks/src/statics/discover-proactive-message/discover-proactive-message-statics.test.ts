import { discoverProactiveMessageStatics } from './discover-proactive-message-statics';

describe('discoverProactiveMessageStatics', () => {
  it('VALID: {guidance} => contains discover tool reference', () => {
    expect(discoverProactiveMessageStatics).toStrictEqual({
      guidance: [
