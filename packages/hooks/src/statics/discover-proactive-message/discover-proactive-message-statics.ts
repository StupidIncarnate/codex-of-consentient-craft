/**
 * PURPOSE: Proactive discover tool guidance for injection into subagent context at spawn time
 *
 * USAGE:
 * discoverProactiveMessageStatics.guidance;
 * // Returns the full discover tool usage guide for proactive injection (not a blocking message)
 */

export const discoverProactiveMessageStatics = {
  guidance: [
    'This project uses the `discover` MCP tool (mcp__dungeonmaster__discover) for code exploration instead of Grep/Glob.',
    '',
