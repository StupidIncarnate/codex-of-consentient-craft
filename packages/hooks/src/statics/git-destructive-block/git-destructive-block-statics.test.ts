import { gitDestructiveBlockStatics } from './git-destructive-block-statics';

describe('gitDestructiveBlockStatics', () => {
  it('VALID: exported value => matches expected shape', () => {
    expect(gitDestructiveBlockStatics).toStrictEqual({
      blockMessage: [
