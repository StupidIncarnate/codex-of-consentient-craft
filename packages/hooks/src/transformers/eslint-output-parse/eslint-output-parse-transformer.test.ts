import { eslintOutputParseTransformer } from './eslint-output-parse-transformer';

describe('eslintOutputParseTransformer', () => {
  describe('valid input', () => {
    it('VALID: {output: \'[{"messages":[]}]\'} => returns EslintResult array', () => {
      const output = '[{"messages":[]}]';

      const result = eslintOutputParseTransformer({ output });
