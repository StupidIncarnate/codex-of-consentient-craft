...
describe('fileUtilIsNodeError', () => {
  describe('valid input', () => {
    it('VALID: Error with code property => returns true', () => {
      const error = new Error('Test error');
      Object.assign(error, { code: 'ENOENT' });

      const result = fileUtilIsNodeError(error);
  ...
  describe('invalid input', () => {
    ...
    it('INVALID: non-Error object with code => returns false', () => {
      ...
      const result = fileUtilIsNodeError(notError);
  ...
  describe('edge cases', () => {
    it('EDGE: null => returns false', () => {
      const result = fileUtilIsNodeError(null);

      expect(result).toBe(false);
    });

    it('EDGE: undefined => returns false', () => {
      const result = fileUtilIsNodeError(undefined);
