...
// normalizeDispatchBoot takes no arguments — `[]` is the exhaustive, honest address. The
// constructor default answers callers that never set up their own scenario, same as the old
// blanket default.
