...
import { requireContractValidationRuleBroker } from './require-contract-validation-rule-broker';

const ruleTester = createEslintRuleTester();

ruleTester.run('require-contract-validation', requireContractValidationRuleBroker(), {
  valid: [
