...
import { enforceOptionalGuardParamsRuleBroker } from './enforce-optional-guard-params-rule-broker';

const ruleTester = eslintRuleTesterAdapter();

ruleTester.run('enforce-optional-guard-params', enforceOptionalGuardParamsRuleBroker(), {
  valid: [
    {
