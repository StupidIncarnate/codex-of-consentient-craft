      ...
      errors: [
        {
          ...
          data: {
            ...
            prefixes: 'VALID:, INVALID:, ERROR:, EDGE:, EMPTY:',
          },
        },
      ],
    },
      ...
      errors: [
        {
          messageId: 'missingPrefix',
          data: {
            name: 'MISSING: {input} => returns null',
            prefixes: 'VALID:, INVALID:, ERROR:, EDGE:, EMPTY:',
          },
        },
      ],
      ...
      errors: [
        {
          messageId: 'missingPrefix',
          data: {
            name: 'SAFETY: {memory} => stays under limit',
            prefixes: 'VALID:, INVALID:, ERROR:, EDGE:, EMPTY:',
          },
        },
      ],
      ...
      errors: [
        {
          messageId: 'missingPrefix',
          data: {
            name: 'FALLBACK: {no file} => uses default',
            prefixes: 'VALID:, INVALID:, ERROR:, EDGE:, EMPTY:',
          },
        },
      ],
      ...
      errors: [
        {
          messageId: 'missingPrefix',
          data: {
            name: 'VALID_ONLY: {only lint} => parses',
            prefixes: 'VALID:, INVALID:, ERROR:, EDGE:, EMPTY:',
          },
        },
      ],
      ...
      errors: [
        {
          messageId: 'missingPrefix',
          data: {
            name: 'should render the component',
            prefixes: 'VALID:, INVALID:, ERROR:, EDGE:, EMPTY:',
          },
        },
      ],
