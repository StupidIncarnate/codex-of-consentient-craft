...
describe('handleSignalLayerBroker', () => {
  ...
  describe('partially-complete signal', () => {
    ...
    it('VALID: {signal: partially-complete, continuationPoint: undefined} => returns respawn action without continuationPoint', async () => {
      const proxy = handleSignalLayerBrokerProxy();
      const stepId = StepIdStub();
      const questFilePath = FilePathStub({ value: '/quests/quest.json' });
      const signal = StreamSignalStub({
  ...
  describe('needs-user-input signal', () => {
    ...
    it('VALID: {signal: needs-user-input, question: undefined, context: undefined} => returns user input result with default values', async () => {
      const proxy = handleSignalLayerBrokerProxy();
      const stepId = StepIdStub();
      const questFilePath = FilePathStub({ value: '/quests/quest.json' });
      const signal = StreamSignalStub({
  ...
  describe('needs-role-followup signal', () => {
    ...
    it('VALID: {signal: needs-role-followup, targetRole: undefined} => returns spawn_role action with default targetRole', async () => {
      const proxy = handleSignalLayerBrokerProxy();
      const stepId = StepIdStub();
      const questFilePath = FilePathStub({ value: '/quests/quest.json' });
      const signal = StreamSignalStub({
    ...
    it('VALID: {signal: needs-role-followup, reason defined, context undefined} => returns spawn_role with reason only', async () => {
      const proxy = handleSignalLayerBrokerProxy();
      const stepId = StepIdStub();
      const questFilePath = FilePathStub({ value: '/quests/quest.json' });
      const signal = StreamSignalStub({
    ...
    it('VALID: {signal: needs-role-followup, reason undefined, context defined} => returns spawn_role with context only', async () => {
      const proxy = handleSignalLayerBrokerProxy();
      const stepId = StepIdStub();
      const questFilePath = FilePathStub({ value: '/quests/quest.json' });
      const signal = StreamSignalStub({
