/**
 * PURPOSE: Proxy for AnswerScreenLayerWidget - minimal since real ink-testing-library is used
 *
 * USAGE:
 * AnswerScreenLayerWidgetProxy();
 * const { lastFrame, stdin } = render(<AnswerScreenLayerWidget ... />);
...
export const AnswerScreenLayerWidgetProxy = (): {
  triggerEscape: () => void;
  triggerEnter: () => void;
