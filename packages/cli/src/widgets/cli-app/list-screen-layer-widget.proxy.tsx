/**
 * PURPOSE: Proxy for ListScreenLayerWidget - minimal since real ink-testing-library is used
 *
 * USAGE:
 * ListScreenLayerWidgetProxy();
 * const { lastFrame, stdin } = render(<ListScreenLayerWidget onBack={onBack} />);
