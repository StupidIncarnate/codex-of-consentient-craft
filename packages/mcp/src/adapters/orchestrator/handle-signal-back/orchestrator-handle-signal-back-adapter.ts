 ...
 * Lets the MCP signal-back tool mark the work item terminal, apply the linked operation's
 * outcome to the quest ledger, and advance the relay without crossing the package boundary
 * inline.
 *
 * USAGE:
