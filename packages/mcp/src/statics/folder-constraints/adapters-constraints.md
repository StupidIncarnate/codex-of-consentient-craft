...
- Adapters add context to errors from npm packages before propagating upward
- Do NOT catch-and-suppress — always re-throw with enriched context or let propagate
