 ...
 * what `installLinkCreateResponder` reads before deciding whether `<repoRoot>/.siegelense` already
 ...
 *
 * USAGE:
 * await fsReadlinkAdapter({ linkPath: AbsoluteFilePathStub({ value: '/repo/.siegelense' }) });
