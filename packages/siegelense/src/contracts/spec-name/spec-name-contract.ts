/**
 * PURPOSE: The human-facing name of a lane spec, such as 'dungeonmaster-stack' or
 * 'dungeonmaster-api'. A browserless spec is not a special case here — an operational flow
 ...
 *
 * USAGE:
 * specNameContract.parse('dungeonmaster-api');
 * // Returns: 'dungeonmaster-api' as SpecName
 */
