 ...
 * RawKeyReading is the browser's answer and nothing else should ever hold one, while a KeyListing is
 ...
 *
 * USAGE:
 * rawKeyReadingContract.parse(await page.evaluate(source));
