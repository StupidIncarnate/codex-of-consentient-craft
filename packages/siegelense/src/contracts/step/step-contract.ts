 ...
 * contract instead of surfacing three steps later inside a broker. Reach for this over
 * `stepVerbContract` whenever the value is a whole step a batch will run; StepVerb only names which
 * of the six it is.
 *
 * USAGE:
