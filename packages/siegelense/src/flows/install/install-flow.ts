/**
 * PURPOSE: Orchestrates siegelense's three install responders — the
 * `.dungeonmaster-assets/siegelense-assets` symlink onto the resolved siegelense root, the
 * `.gitignore` (and eslint-ignore) entries that keep it off
