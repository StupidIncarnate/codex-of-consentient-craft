 ...
 * the extension each per-instance record takes, and the settle window that decides when a beat stops
 * counting as boot and starts counting as steady. These stay out of `locationsStatics`: that file's
