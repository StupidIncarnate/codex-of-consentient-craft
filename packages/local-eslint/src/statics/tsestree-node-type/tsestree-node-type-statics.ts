 ...
 *
 * NOTE: This is an intentional duplicate of the same statics in @dungeonmaster/eslint-plugin.
 * local-eslint is a repo-private ESLint plugin that is never published; the duplication keeps
 * it fully self-contained and avoids cross-package subpath imports / barrel shims.
 */
