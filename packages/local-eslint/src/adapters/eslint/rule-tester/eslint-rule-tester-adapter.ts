 ...
 *
 * NOTE: This is an intentional duplicate of @dungeonmaster/eslint-plugin's rule-tester
 * adapter. local-eslint is a repo-private ESLint plugin; duplicating keeps it self-contained.
 */
...
const eslintRuleNameContract = z.string().min(1).brand<'EslintRuleName'>();
type EslintRuleName = z.infer<typeof eslintRuleNameContract>;
