 ...
 *
 * NOTE: This is an intentional duplicate of @dungeonmaster/eslint-plugin's tsestree contract.
 * local-eslint is a repo-private ESLint plugin that is never published; duplicating the
 * contract keeps local-eslint fully self-contained and avoids cross-package subpath imports.
 */
import { z } from 'zod';
