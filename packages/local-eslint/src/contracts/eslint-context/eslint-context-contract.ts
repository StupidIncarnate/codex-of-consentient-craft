 ...
 *
 * NOTE: This is an intentional duplicate of @dungeonmaster/eslint-plugin's eslint-context
 * contract. local-eslint is a repo-private ESLint plugin that is never published;
 * duplicating the contract keeps local-eslint fully self-contained.
 */
import { z } from 'zod';
