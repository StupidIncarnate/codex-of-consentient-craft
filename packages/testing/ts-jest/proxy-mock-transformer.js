...
const { typescriptProxyMockTransformerMiddleware } = require('../dist/middleware/typescript-proxy-mock-transformer/typescript-proxy-mock-transformer-middleware');
const { typescriptProgramContract } = require('../dist/contracts/typescript-program/typescript-program-contract');
...
exports.factory = ({ program }) => ({ factory: nodeFactory }) => (sourceFile) => {
