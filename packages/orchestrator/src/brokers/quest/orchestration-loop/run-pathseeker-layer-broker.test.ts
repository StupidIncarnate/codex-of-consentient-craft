...
// Five blightwarden minions are minted between the lawbringers and the synthesizer.
const MINION_SEC_UUID = '99999999-9991-4991-8991-999999999901';
const MINION_DEDUP_UUID = '99999999-9992-4992-8992-999999999902';
const MINION_PERF_UUID = '99999999-9993-4993-8993-999999999903';
const MINION_INTEG_UUID = '99999999-9994-4994-8994-999999999904';
const MINION_DEAD_UUID = '99999999-9995-4995-8995-999999999905';
