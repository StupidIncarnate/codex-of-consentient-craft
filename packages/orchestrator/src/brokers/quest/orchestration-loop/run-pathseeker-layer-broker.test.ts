...
// Blightwarden is a single work item between the lawbringers and the final ward (it summons its
// minions as sub-agents itself, so no minion work items are minted here).
