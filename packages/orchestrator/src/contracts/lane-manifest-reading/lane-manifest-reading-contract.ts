 ...
 *   logs: {
 *     api: { path: '/repo/.siegelense/g1/instances/inst_7f3a9c21/api-server.log', linkPresent: true },
 *     web: { path: '/repo/.siegelense/g1/instances/inst_7f3a9c21/web-server.log', linkPresent: true },
 *   },
 * });
