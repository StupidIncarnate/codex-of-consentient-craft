/**
 * PURPOSE: Writes orchestrator install files (slash commands and agent prompts) to the target project
 *
 * USAGE:
 * const result = await InstallWriteFilesResponder({ context });
 * // Creates .claude/commands/ with quest.md and quest:start.md,
 * // and .claude/agents/ with finalizer-quest-agent.md and quest-gap-reviewer.md
 */
...
export const InstallWriteFilesResponder = async ({
  context,
}: {
