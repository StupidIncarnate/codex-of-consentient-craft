...
import { OrchestrationAbandonResponder } from './orchestration-abandon-responder';

type Quest = ReturnType<typeof QuestStub>;

export const OrchestrationAbandonResponderProxy = (): {
  callResponder: typeof OrchestrationAbandonResponder;
  ...
  return {
    callResponder: OrchestrationAbandonResponder,
